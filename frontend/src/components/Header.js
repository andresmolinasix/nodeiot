        ...
        <header className="navbar navbar-dark px-5 custom-bg">
            <div className="container-fluid d-flex justify-content-between align-items-center">
                ...
                <div className="d-none d-md-flex ms-auto">
                    <NavLink to="/registro" className="nav-link btn btn-success text-white px-4 py-2 rounded me-3 fw-bold">
                        Registro
                    </NavLink>
                    <NavLink to="/login" className="nav-link btn btn-success text-white px-4 py-2 rounded fw-bold">
                        Iniciar sesión
                    </NavLink>
                </div>
