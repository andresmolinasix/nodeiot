...
const Header = () => {
    ...
    return (
        <header className="navbar navbar-dark px-5 custom-bg fixed-navbar">
            <div className="container-fluid d-flex justify-content-between align-items-center">
                ...
                <div className="d-none d-md-flex ms-auto">
                    ...
                    <NavLink to="/anomalias" className="nav-link btn btn-custom text-white px-4 py-2 rounded me-3 fw-bold">
                        Monitor
                    </NavLink>
                    <NavLink to="/histogramas" className="nav-link btn btn-custom text-white px-4 py-2 rounded fw-bold">
                        Histograma
                    </NavLink>

                </div>

                <NavLink to="/" className="nav-link btn btn-salir text-white ms-auto px-4 py-2 rounded fw-bold">
                    Cerrar Sesión
                </NavLink>
